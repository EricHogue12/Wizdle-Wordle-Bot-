...
class BestWords:
    ...
    def goodWords(self, words, possible):
        # list of frequencies
        freq1 = self.frequencies(words, possible)
        ...
        for i in range(len(index1)):
            retWordList.append(possible[index1[i]])
        return retWordList



    # returns a list of total frequencies for each word
    def frequencies(self, words, possible):
    ...
    #returns list of letter frequencies for the ith position of possle posss (index 0 of list is how many times A occurs)
